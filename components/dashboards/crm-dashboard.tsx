    ...
    <DashboardLayout title="CRM Dashboard" role="crm">
      <main className="flex-1 space-y-6 p-4 md:p-6 overflow-y-auto">
        ...
        <Tabs defaultValue="customers" className="space-y-6">
          {/* FIX: Made the tab list responsive. It's 2 columns on mobile and 4 on larger screens. */}
          ...
          <TabsContent value="customers" className="space-y-6">
            <Card>
              <CardHeader>
                {/* FIX: Header now stacks on mobile and is a row on larger screens. */}
                ...
                <div className="space-y-4">
                  {mockCustomers.map((customer) => (
                    <div key={customer.id} className="border rounded-lg p-4">
                      {/* FIX: Main card layout stacks vertically on mobile, row on desktop. */}
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            {/* FIX: Contact details stack on mobile */}
                        ...
                        {/* FIX: Action section aligns left on mobile, right on desktop */}
                        <div className="text-left md:text-right">
                          ...
                          {/* FIX: Buttons wrap and use gap for spacing */}
          ...
          {/* Apply similar responsive fixes for the Leads tab */}
          <TabsContent value="leads" className="space-y-6">
            <Card>
              <CardHeader>
                {/* FIX: Header now stacks on mobile */}
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <div>
                    <CardTitle className="flex items-center">
